...
function Button({label,disabled,outline,small,custom,icon:Icon,onClick}: Props) {
  return (
  ...
  ${small ? "text-sm py-1 px-2 font-light border-[1px]" : "text-lg py-3 px-4 font:bold border-2"}
  ${custom ? custom : ""}
  `}>
    {Icon && <Icon size={24}/>}
    {label}
