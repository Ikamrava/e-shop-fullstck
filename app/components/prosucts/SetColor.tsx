...
function SetColor({images,cartProduct,handleColorSet}: Props) {
  return (
    <div>
        <div className=" flex gap-4 items-center ">
            ...
            <div className=" flex gap-1">
                {images.map((image, index) => (
                    <div  key = {index} className={`h-7 w-7 rounded-full border-teal-300 flex items-center justify-center
